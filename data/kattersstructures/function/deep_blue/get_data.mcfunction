...
execute if dimension overworld run return run function kattersstructures:deep_blue/adjust_height_deep_blue with storage kattersstructures:temp portal.create
execute if dimension kattersstructures:deep_blue run return run function kattersstructures:deep_blue/adjust_height_overworld with storage kattersstructures:temp portal.create
