...
execute store result storage kattersstructures:temp portal.create.ExitPosX int 1 run data get entity @s Pos[0]
execute store result storage kattersstructures:temp portal.create.ExitPosY int 1 run data get entity @s Pos[1]
execute store result storage kattersstructures:temp portal.create.ExitPosZ int 1 run data get entity @s Pos[2]
