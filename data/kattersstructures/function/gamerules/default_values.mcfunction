...
data modify storage kattersstructures:temp settings.arachne set value true
data modify storage kattersstructures:temp settings.raj set value true
data modify storage kattersstructures:temp settings.tenku set value true
data modify storage kattersstructures:temp settings.theron set value true
data modify storage kattersstructures:temp settings.rusta set value true
