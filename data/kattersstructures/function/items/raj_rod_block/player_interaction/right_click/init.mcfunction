...
execute if items entity @s weapon.mainhand minecraft:blaze_rod[item_name={"bold": false,"color": "white","italic": false,"text": "Raj's Lightning Rod"}] run function kattersstructures:items/raj_rod_block/player_interaction/right_click/give_item
