...
schedule function kattersstructures:items/theron_spells/the_beast_within_2 2t
...
execute as @s at @s if predicate kattersstructures:entity/has_3_levels run function kattersstructures:items/theron_spells/the_beast_within_effect
