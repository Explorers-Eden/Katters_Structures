...
schedule function kattersstructures:items/theron_spells/the_soul_siphon_2 2t
...
execute as @s at @s if predicate kattersstructures:entity/has_3_levels run function kattersstructures:items/theron_spells/the_soul_siphon_effect
