...
execute as @s at @s if score $kattersstructures.the_beast_within kattersstructures.technical matches 10 run schedule function kattersstructures:items/theron_spells_nm/kill_player 3t
