...
execute as @e[type=turtle,tag=katter.tenku.vehicle] at @s unless entity @e[type=armor_stand,tag=katter.tenku.asset,distance=..12] run function kattersstructures:tenku/spawn_assets