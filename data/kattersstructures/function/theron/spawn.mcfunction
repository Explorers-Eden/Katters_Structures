summon block_display ~ ~.5625 ~ {Tags:["katter.theron.rod","katter.theron.phase_01"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1f,-0.5625f,-1f],scale:[2f,1.125f,2f]},block_state:{Name:"minecraft:lightning_rod",Properties:{facing:"up",powered:"false",waterlogged:"false"}}}
